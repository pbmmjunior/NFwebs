    ...
    $.extend($.validator, {
        defaults: {
            ...
            highlight: function (element, errorClass, validClass) {
                if ($(element).attr("id") != undefined && $($("#" + $(element).attr("id"))).hasClass("selectpicker-busca")) {
        ...
        messages: {
            ...
            maxlength: $.validator.format("Não informe mais que {0} caracteres."),
            ...
            range: $.validator.format("Informe um valor entre  {0} and {1}."),
